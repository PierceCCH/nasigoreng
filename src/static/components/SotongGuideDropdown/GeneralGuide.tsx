...
class GeneralGuidePage extends React.Component<{ appState: IAppState }, ISGState> {
    constructor(props) {
        super(props);
    ...
    refreshGuide(force: Boolean = false) {
        axios.get<IGuideResponse>("/api/General" + (force ? "?force=true" : ""))
        .then(data => {
            this.setState({
            ...
            <div className="sotong-guide page mt-2">
                <div className="row align-items-center">
                    <div className="col d-flex">
                        ...
                        <h1 className="mb-0">General Information</h1>
                    </div>
                </div>
...
export default GeneralGuidePage;
