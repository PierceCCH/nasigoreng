...
const Config = {
  ...
  SOTONG_GUIDE_VISA_URL: process.env.SOTONG_GUIDE_VISA_URL,
  SOTONG_GUIDE_DEPARTURE_URL: process.env.SOTONG_GUIDE_DEPARTURE_URL,
  SOTONG_GUIDE_ONCAMPUS_URL: process.env.SOTONG_GUIDE_ONCAMPUS_URL,
  SOTONG_GUIDE_SETTLING_URL: process.env.SOTONG_GUIDE_SETTLING_URL,
  SOTONG_GUIDE_ACADEMICS_URL: process.env.SOTONG_GUIDE_ACADEMICS_URL,
  SOTONG_GUIDE_GENERAL_URL: process.env.SOTONG_GUIDE_GENERAL_URL,
